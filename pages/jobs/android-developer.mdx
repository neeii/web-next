...
description: To write code and improve the Save app
date: 9/25/23
---
...
The android developer will help us make our app **_Save_** and archival process as easy as possible for our users and [Decentralized Archivist Communities (DACs)](https://open-archive.org/programs). 
...
A commitment to free and open-source software, good communication and documentation skills, and a passion for contributing to the greater good are all essential.
...
**B e comfortable working remotely with a geographically distributed team
...
This is a Part-time contractor role, 10-20 hours a week, 6-12 months at a competitve nonprofit rate. The renewal of the contract and increases in payment are dependent on funding and performance.
