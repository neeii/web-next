...
<TeamSection>
    ...
    <TeamItem expand>
        ![Madeline de Figueiredo](Team/Madeline.jpg)
    ...
    <TeamItem expand>
        ![Benjamin Erhart](Team/Benjamin.jpg)
    ...
    <TeamItem>
     ...
     <TeamItem>
        ![Silvia Puglisi](Team/Silvia.jpg)

        ###### Silvia Puglisi

        Tech Lead

        Silvia is a Systems Engineer and Privacy Researcher based in Barcelona, EU. She currently the metrics team lead at the [tor project](https://www.torproject.org/). She is deeply committed to protecting human rights and is actively involved in a number of projects that aim to promote privacy, transparency and freedom online.
    ...
    <TeamItem expand>
        ...
        Decentralize Archivist Community, Latin America Manager
    ...
    <TeamItem expand>
        ![Marisa](Team/Marisa.jpg)

        ###### Marisa Iovino

        Social Media Manager

        Marisa is an information activist passionate about digital autonomy and privacy. She lives in New York but grew up online. She is committed to making the Internet accessible, inclusive, and safe. She hopes to design tangible and ethical solutions to oppressive technologies. Marisa is completeing a Master's degree in Media Studies at CUNY Queens College and a certificate in Interactive Technology and Pedagogy from CUNY Graduate Center. [Contact her here](mailto:miovino94@gmail.com) to talk about everything related to digital culture, ethical technology, and reality TV.
    </TeamItem>
</TeamSection>
<BoardSection>
    ## **Advisory** Board
